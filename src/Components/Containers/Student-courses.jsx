    ...
    <div className="student-list-card just-center  ">
      <div className="just-center ">
        ...
        <div className="student-list-box color-primary h-16-semi ">
          ...
          <img className="img" alt="img" height="130" width="180" src={img2} />
          </span>
          <div className="student-list-inner-box">

          </div>
          <div className="create-list-btn d-flex-ac just-center  ">
          <ListLogo color="#fefdff" />
            <h2 className="color-background h-20-bold"><a className="color-pure" href="/studentcoursedetails">View</a></h2>
          </div>
        </div>
      </div>
    </div>
