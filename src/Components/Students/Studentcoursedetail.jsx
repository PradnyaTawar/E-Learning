...
export default class Studentcoursedetail extends Component {
  constructor(props) {
    super(props);
    this.state = {
      data: [],
          ...
          <div className="sign-in-form">
            <div className="input-div">
              ...
              <label class="input-label h-20-semi  ">
                Start our course free of charge to discover just some of the
                ways businesses can reach and connect with more customers
                online. Plus, learn how to improve your search engine
                performance (SEO), and use online advertising (S EM) to boost
                sales and awareness.
              </label>
            </div>
          </div>
